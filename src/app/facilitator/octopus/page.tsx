...
export default function OctopusGalleryPicker() {
  return (
...
function Inner({ user }: { user: User }) {
  ...
  return (
    <Shell user={user} back="/facilitator">
      <Hero
        eyebrow="Octopus · Gallery"
        title="Which gallery are you in?"
        subtitle="Pick the gallery; you'll log a visitor's session next."
      />
